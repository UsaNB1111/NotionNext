...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个视频UP主,你挖掘到了一个金子,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '爱玩电脑的Edge', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个小众的UP主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.msgzs.cloudns.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'B站,UP主,博客', // 网站关键词 英文逗号隔开
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'UsaNB1111/Save-utterance', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个电脑科技类UP主', // 站点描述，被notion中的页面描述覆盖
