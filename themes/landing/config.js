const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_TITLE: 'B站主页',
  LANDING_HEADER_BUTTON_1_URL: 'https://space.bilibili.com/168058198',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://www.msgzs.cloudns.org/',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: '探索！',
  LANDING_HERO_P_1: '我们一起成长！开始你的旅途吧！',
  LANDING_HERO_BUTTON_1_TEXT: '个人网站',
  LANDING_HERO_BUTTON_1_LINK: 'https://www.msgzs.cloudns.org/',
  LANDING_HERO_BUTTON_2_TEXT: '关于',
  LANDING_HERO_BUTTON_2_LINK: 'https://www.msgzs.cloudns.org/about',
  LANDING_HERO_VIDEO_IMAGE: '/images/home.png',
  //   HERO_VIDEO_URL: '/videos/video.mp4',
  LANDING_HERO_VIDEO_IFRAME: 'https://space.bilibili.com/168058198',
  LANDING_HERO_VIDEO_TIPS: 'B站主页',

  // 特性介绍
  //LANDING_FEATURES_HEADER_1: '探索的过程',
  //LANDING_FEATURES_HEADER_1_P: "如何搭建自己的",
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://www.msgzs.cloudns.org/', // 重定向网站地址

  LANDING_PRICING_TITLE: '我的视频',
  LANDING_PRICING_P: '我们一起成长，一起知道的更多！',
